...
def main():
    ...
    #web_history = get_web_history("/home/arunprakash/.config/google-chrome/Default/History")
    #web_history = get_web_history(r"\AppData\Local\Google\Chrome\User Data\profile 23\databases\databases")
    data_path = os.path.expanduser('~') + r"\AppData\Local\Google\Chrome\User Data\profile 23"
    files = os.listdir(data_path)
    history_db = os.path.join(data_path, 'history')
    web_history = get_web_history(history_db)
